...
public class DeelnemerResourceIT {
    ...
    public void setup() {
        ...
        final DeelnemerResource deelnemerResource = new DeelnemerResource(deelnemerService, jaarlijksePremieStortingBerekeningService, verwachteWaardePensioenBerekeningService, pensioenRegelingService);
    ...
    public static Deelnemer createUpdatedEntity(EntityManager em) {
        Deelnemer deelnemer = Deelnemer.builder()
            ...
            .deeltijdPercentage(UPDATED_DEELTIJDPERCENTAGE).build();
        return deelnemer;
    }
    ...
    @Test
    @Transactional
    public void createDeelnemer() throws Exception {
        ...
        assertThat(testDeelnemer.getEinddatumDienst()).isEqualTo(DEFAULT_EINDDATUM_DIENST);
        assertThat(testDeelnemer.getStartdatumDienst()).isEqualTo(DEFAULT_STARTDATUM_DIENST);
        assertThat(testDeelnemer.getVoltijdsalaris()).isEqualTo(DEFAULT_VOLTIJDSALARIS);
        assertThat(testDeelnemer.getHuidigeWaardeBeleggingen()).isEqualTo(DEFAULT_HUIDIGE_WAARDE_BELEGGINGEN);
        assertThat(testDeelnemer.getRekening()).isEqualTo(DEFAULT_REKENING);
    }

    @Test
    @Transactional
    public void createDeelnemerWithExistingId() throws Exception {
        int databaseSizeBeforeCreate = deelnemerRepository.findAll().size();
    ...
    public void getAllDeelnemers() throws Exception {
        ...
        restDeelnemerMockMvc.perform(get("/api/deelnemers?sort=id,desc"))
    ...
    public void getDeelnemer() throws Exception {
        ...
        // Get the deelnemer
        restDeelnemerMockMvc.perform(get("/api/deelnemers/{id}", deelnemer.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    public void getNonExistingDeelnemer() throws Exception {
        // Get the deelnemer
        restDeelnemerMockMvc.perform(get("/api/deelnemers/{id}", Long.MAX_VALUE))
    ...
    public void updateDeelnemer() throws Exception {
        ...
        updatedDeelnemer = Deelnemer.builder()
            ...
            .voltijdsalaris(UPDATED_VOLTIJDSALARIS)
            .huidigeWaardeBeleggingen(UPDATED_HUIDIGE_WAARDE_BELEGGINGEN)
            .rekening(UPDATED_REKENING).deeltijdPercentage(UPDATED_DEELTIJDPERCENTAGE).id(updatedDeelnemer.getId()) .build();
    ...
    public void deleteDeelnemer() throws Exception {
        ...
        restDeelnemerMockMvc.perform(delete("/api/deelnemers/{id}", deelnemer.getId())
